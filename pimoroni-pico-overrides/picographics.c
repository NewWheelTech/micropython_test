...
STATIC const mp_map_elem_t picographics_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_DISPLAY_1BIT_MEMORY_168X144), MP_ROM_INT(DISPLAY_1BIT_MEMORY_168X144) },
    { MP_ROM_QSTR(MP_QSTR_DISPLAY_1BIT_MEMORY_144X168), MP_ROM_INT(DISPLAY_1BIT_MEMORY_144X168) },
